...
- Realtime ingestion compat routes are always registered; optional tuning knobs remain `REALTIME_MIN_CHARS_DELTA`, `REALTIME_MIN_SECONDS_BETWEEN_INDEX`, and `REALTIME_USE_REDIS_STREAMS`
