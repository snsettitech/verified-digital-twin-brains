...
- **Routes**: Uses shared specialization endpoints; no separate VC-only router is mounted
...
- ✅ **Specialization routing**: Shared specialization endpoints stay mounted without a VC-only router
...
| **VC Routes** | Not mentioned | Removed from active runtime | ✅ Cleaned up |
