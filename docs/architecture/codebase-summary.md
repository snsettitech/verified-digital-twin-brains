...
- **Routes**: No dedicated VC-only router; functionality lives in shared specialization surfaces
...
- ✅ **VC specialization**: Loaded through shared specialization surfaces without a separate VC-only router gate
...
5. **VC Specialization**: Mention that VC behavior now relies on shared specialization surfaces
