...
- **Routes**: Uses the shared specialization endpoints
...
- ✅ **VC specialization**: Uses shared routes plus lazy-loaded manifests
...
| **VC Specialization** | Not mentioned | Shared routes + lazy manifests | ⚠️ New feature |
...
5. **VC Specialization**: Mention shared routes and lazy manifest loading
