...
- **Routes**: Exposed via the shared `specializations` router and specialization manifests
...
5. **VC specialization**: Mention shared specialization routing and manifests
