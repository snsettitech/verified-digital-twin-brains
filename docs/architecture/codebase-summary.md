...
- **Routes**: Uses shared specialization routes under `/specializations`
...
- ✅ **VC specialization**: Served through shared specialization routes with lazy manifest loading
...
|--------|--------------|---------------|--------|
| **Routers** | 16 | 16 core router groups (VC uses shared specialization routes) | ⚠️ Minor update |
...
| **VC Specialization** | Not mentioned | Shared specialization manifest + lazy loading | ⚠️ New feature |
...
2. **Router Count**: Update route inventory to reflect current shared specialization routing
3. **Module Count**: 33 modules (not 25+)
4. **P0-P1 Hardening**: Add section on recent reliability/security improvements
5. **VC Specialization**: Mention shared specialization routing and lazy loading
