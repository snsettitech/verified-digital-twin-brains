...
- **Routes**: No dedicated VC-only API router in the current backend
...
- ✅ **VC specialization**: Lazy-loaded registry entry with vanilla fallback protection
...
5. **VC Specialization**: Mention lazy loading without a dedicated VC-only router
