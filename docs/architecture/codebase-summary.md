...
- **Routes**: Uses shared specialization route surfaces
...
- ✅ **Specialization routing**: Shared specialization routes stay mounted for all specializations
...
2. **Router Count**: Recount against the current mounted router set in `backend/main.py`
3. **Module Count**: 33 modules (not 25+)
4. **P0-P1 Hardening**: Add section on recent reliability/security improvements
5. **Specialization Routing**: Note that VC behavior now rides through shared specialization routes
