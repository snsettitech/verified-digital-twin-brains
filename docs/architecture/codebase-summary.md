...
- **Routes**: Uses shared backend routes; no dedicated VC router is mounted
...
- ✅ **VC specialization**: Lazy loading keeps VC-specific code out of the startup path
...
5. **VC Specialization**: Mention lazy loading and shared route usage
