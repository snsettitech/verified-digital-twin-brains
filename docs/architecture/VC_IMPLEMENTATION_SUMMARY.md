...
> Historical note: this document describes a prior VC-route design that used `ENABLE_VC_ROUTES`. The live application no longer registers VC-specific routes from `backend/main.py`.
