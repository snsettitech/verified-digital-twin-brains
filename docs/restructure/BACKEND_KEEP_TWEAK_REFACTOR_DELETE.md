...
| Specializations + VC | Delete or defer | `backend/routers/specializations.py`, `backend/modules/specializations/*` | New product is general clone-for-experts; the historical dedicated VC router is already gone. |
