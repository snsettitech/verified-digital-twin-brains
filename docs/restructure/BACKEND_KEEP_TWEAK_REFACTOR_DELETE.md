...
| Specializations + VC | Delete or defer | `backend/routers/specializations.py`, legacy retired `backend/api/vc_routes.py`, `backend/modules/specializations/*` | New product is general clone-for-experts; no VC specialization. |
