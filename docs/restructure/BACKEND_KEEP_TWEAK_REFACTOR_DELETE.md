...
| Specializations + VC | Delete or defer | `backend/routers/specializations.py`, `backend/modules/specializations/*`, historical VC route artifacts | New product is general clone-for-experts; no VC specialization. |
