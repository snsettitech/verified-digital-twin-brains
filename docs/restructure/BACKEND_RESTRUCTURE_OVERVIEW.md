...
- Conditional routers: `enhanced_ingestion` gated by `ENABLE_ENHANCED_INGESTION` in `backend/main.py`. No `api/vc_routes.py` module is present in the current backend tree.
