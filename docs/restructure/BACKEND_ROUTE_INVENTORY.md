...
### Historical VC-only upload surface
The live backend no longer registers a dedicated VC router. VC-specific behavior now flows through shared specialization manifests and twin configuration routes instead of a separate upload endpoint.
