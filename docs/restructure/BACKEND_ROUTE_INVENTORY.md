...
### VC Route Status
No dedicated `backend/api/vc_routes.py` router is registered in the current app. VC specialization support is limited to the shared specialization manifests and modules under `backend/modules/specializations/vc/`.
