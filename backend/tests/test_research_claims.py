...
# =============================================================================
# Deep Research Configuration Tests
# =============================================================================

class TestDeepResearchConfig:
    """Test active Deep Research configuration behavior."""
    
    @patch("os.getenv")
    def test_name_only_flag_tracks_env(self, mock_getenv):
        """Name-only flow should still honor its active env gate."""
