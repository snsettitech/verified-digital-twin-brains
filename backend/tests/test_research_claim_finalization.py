...
class TestFeatureFlags:
    """Test Phase 10 feature flags."""
    
    @patch("os.getenv")
    def test_phase_10_disabled_flag(self, mock_getenv):
        """Test DR_PHASE_10_CLAIM_FINALIZATION_DISABLED flag is respected."""
        ...
        assert config.phase_10_claim_finalization_disabled == True
    
    @patch("os.getenv")
    def test_phase_10_enabled_by_default(self, mock_getenv):
        """Test Phase 10 is enabled by default."""
        from modules.deep_research_config import DeepResearchConfig
        ...
        assert config.phase_10_claim_finalization_disabled == False
