-- ============================================================================
-- Migration: Graph Memory Single-Profile Scope
-- Purpose: Add scope_id columns for single-profile isolation
-- Safety: Additive only, all new columns nullable initially
-- Rollback: Drop scope_id columns if needed
-- ============================================================================
