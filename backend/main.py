...
# ISSUE-003 cleanup: stable routes are always registered; only optional
# rollouts remain behind env flags.
...
# Stable realtime ingestion routes are always registered when the compat
# router is available, even if full streaming infrastructure is absent.
