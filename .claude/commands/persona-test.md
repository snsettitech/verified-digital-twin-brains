...
4. If the name-only JSON flow is involved, check `NAME_ONLY_DEEP_RESEARCH_ENABLED=true` in production env vars (core deep-research routes are always registered)
```
