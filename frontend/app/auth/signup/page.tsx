        ...
        <div>
            ...
            <div className="bg-[#111117] border border-white/10 rounded-2xl p-8 backdrop-blur-xl shadow-2xl">
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-3 px-4 py-3 mt-3 bg-[#0A66C2] hover:bg-[#004182] text-white font-semibold rounded-xl transition-all disabled:opacity-50"
                >
