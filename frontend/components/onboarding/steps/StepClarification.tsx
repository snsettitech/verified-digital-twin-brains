...
export function StepClarification({ twinId, onComplete }: StepClarificationProps) {
    ...
    return (
      <div className="space-y-6">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold mb-2">Clarification Questions</h2>
          <p className="text-slate-400">
            No clarification needed. Your claims are sufficient!
          </p>
        </div>
        <button
          onClick={onComplete}
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold mb-2">Clarification Questions</h2>
        <p className="text-slate-400">
          Help us understand your preferences better. These answers will improve your persona's accuracy.
        </p>
      </div>
      ...
      <div className="bg-slate-800/50 p-4 rounded-lg border border-slate-700">
        <p className="text-sm text-slate-400">
          <span className="text-amber-400">💡 Tip:</span> Be specific. Instead of "I like good teams," say "I look for teams with prior domain experience and complementary skills."
        </p>
      </div>
