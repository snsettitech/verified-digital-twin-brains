  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold mb-2">Review Extracted Claims</h2>
      ...
      {claims.length === 0 && (
        <div className="text-center py-8 text-slate-400">
          ...
          <p className="text-sm mt-2">You may need to submit more content or try different sources.</p>
        </div>
      )}
